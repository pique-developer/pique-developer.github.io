...
export const Apple = ({ className, style }) => {
  return (
    <svg
      className={className}
      style={style}
      x="0px"
      y="0px"
      viewBox="0 0 45.721 45.721"
      enableBackground="new 0 0 45.721 45.721">
      <g>
        <path
          fill="#a0a0a0"
          d="M31.686,11.161c-2.615-0.057-5.047,1.063-7.073,2.882c-0.344-2.371-1.271-4.273-1.271-4.273
