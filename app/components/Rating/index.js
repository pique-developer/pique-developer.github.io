...
const StarFill = ({ style }) => (
  <svg width="28px" height="28px" style={style} viewBox="30 -2 33 33">
    <defs>
...
const StarNoFill = ({ style }) => (
  <svg width="28px" height="28px" style={style} viewBox="132 -2 33 33">
    <defs>
